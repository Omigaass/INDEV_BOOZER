...
if (empty($_POST['USER_NAME']) || empty($_POST['USER_PASSWORD']) || empty($_POST['USER_EMAIL']) || empty($_POST['USER_CPFCNPJ'])) {
    OpenAlert("Por favor, preencha todos os campos obrigatórios.");
